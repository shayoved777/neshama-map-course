#############################################
# streamlit_app.py (גרסה בדוקה היטב)
#############################################
...
#############################################
st.set_page_config(
    page_title="מפת הנשמה - גרסה מורחבת, נבדקת ומוכנה",
    page_icon="✨",
    layout="centered",
)
...
zodiac_data = {
    "טלה": {
        ...
        "tanya": (
            "בתניא (למשל בפרק ל') מודגש שבעלי התלהבות ראשונית נדרשים להכניס חום זה "
            "לעבודת ה' ומצוות."
        ),
    ...
    "בתולה": {
        ...
        "tanya": (
            "בתניא מודגש שתהליך איטי של אתכפיא דורש תשומת לב לפרטים "
            "במעשים היומיומיים."
        ),
    ...
    "מאזניים": {
        ...
        "summary": "מאזניים: הרמוניה וצדק. תיקון: החלטיות ולא להיתקע בין לבטים."
    },
    "עקרב": {
        "intro": (
        ...
        "zohar": (
            "הזוהר: כוח לרדת לשורשי החושך ולעלות משם ניצוצות, "
            "אך ביד האדם להיזהר מכעס ונקמה."
        ),
        "arizal": (
            "האר״י: 'ירידה לצורך עלייה' — לבעלי נשמה חזקה הנלחמים ביצר."
        ),
        "tanya": (
    ...
    "קשת": {
        ...
        "tanya": (
            "בתניא מעודדים להפוך את שמחת הקשת לשמחה פנימית באמונה, "
    ...
    "גדי": {
        ...
        "zohar": (
            "הזוהר מלמד שעלייה איטית אך בטוחה כמוה כסולם מוצב — "
            "מרמז לחוסן הגדי בהרים תלולים."
        ),
        "arizal": (
            "האר״י רומז שכוח 'מלכות' בגדי מתבטא בבנייה לטווח ארוך בעולם הגשמי."
        ),
        "tanya": (
            "התניא מבהיר שעבודה מתמדת לבסוף שוברת את היצר העיקש, "
    ...
    "דלי": {
        ...
        "pasuk": "“וַיִּבֶן עִיר חֲדָשָׁה” (רמז לבנייה חדשה)",
        "zohar": (
        ...
        "summary": "דלי: מקוריות ושאיפה לשפר את העולם. תיקון: לחדש בחוכמה ולא להרוס הכול."
    },
    "דגים": {
        "intro": (
        ...
        "zohar": (
            "הזוהר: הדגים מייצגים פנימיות נסתרת, שחיה 'תחת פני המים'."
        ),
        "arizal": (
            "האר״י: נפשות עדינות זקוקות למסגרת כדי לא להישאב לרגש שלילי."
        ),
        "tanya": (
            "התניא: חשוב לשלב חמלה עמוקה עם כלים שכליים, "
            "כדי לא לטבוע בעולמות דמיון."
        ),
...
# ממשק האפליקציה
#############################################
st.title("מפת הנשמה - גרסה מורחבת (נבדקה פעמיים)")

st.markdown("מלא/י את הפרטים וקבל/י מפת מזל מורחבת, חישוב גימטריה וכו':")
...
with st.form("neshama_form"):
    ...
    submitted = st.form_submit_button("הפק מפה")
...
if submitted:
    if not user_name or not mother_name:
        ...
        if st.button("לחץ/י כאן לרכישה"):
            st.success("מקום לשלב מנגנון תשלום או קישור חיצוני…")
